...
## bug fixing.
## 20170222: Min and max identity range is required new.
...
Notes:
   1) This script is for close-related species pairs. For divergent species pair, the 
   ...
   5) The target and query names used for "target.query.raw.q" are extracted
